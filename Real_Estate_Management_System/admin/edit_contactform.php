    ...
    <div class="logo-details">
     <!-- <i class='bx bxl-c-plus-plus'></i>-->
      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="contactform.php" class="active">
            <i class='bx bx-message' ></i>
      ...
      <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                {
                    $user_id = $_GET['id'];
                    $user_form = "SELECT * FROM contact WHERE id='$user_id'" ;
                    ...
                    <form action="code.php" method="POST" >
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text"   value="<?=$user_form['name'];?>" class="form-control">
                            </div>
                            <div class="col-md-12 mb-3">
                                <label for="">email</label>
                                <input type="text"  value="<?=$user_form['email'];?>"class="form-control">
                            </div>

                            <div class="col-md-12 mb-3">
                                <label for="">moblieno</label>
                                <input type="text"   value="<?=$user_form['pho_no'];?>" class="form-control">
                            </div>
                            <div class="col-md-12 mb-3">
                                <label for="">Subject</label>
                                <input type="text"   value="<?=$user_form['subject'];?>" class="form-control">
                            </div>
                            <div class="col-md-12 mb-3">
                                <label for="">Message</label>
                                <input type="text"  value="<?=$user_form['message_1'];?>" class="form-control">
                            </div><br>
