           ...
           foreach($query_run as  $row) {
               ?>
                <tr>
                   ...
                   <td><?=$row['subject']; ?></td>
                   <td><?=$row['message_1']; ?></td>
                   <td><a href="edit_contactform.php?id=<?=$row['id']; ?>" class="btn btn-success">View</td>
                   
                 

                   <td>
                     <form action="code.php" method="POST">
                      <button  type="submit" name="conatct_delete" value="<?=$row['id']; ?>" class="btn btn-danger">Delete</button>
                  </td>
                   </form>
                </tr>
               <?php
