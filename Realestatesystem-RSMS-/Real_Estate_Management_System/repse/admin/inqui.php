  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">RealEstate Management System - Inquiry List</span>
      </div>
           ...
           foreach($query_run as  $row) {
               ?>
                <tr>
                   ...
                   <td><a href="" class="btn btn-success"><?=$row['status']; ?></td>
                   <td><a href="edit_inquilist.php?id=<?=$row['id']; ?>" class="btn btn-success">Edit</td>

                   <td>
                     <form action="code.php" method="POST">
                      <button  type="submit" name="inqui_delete" value="<?=$row['id']; ?>" class="btn btn-danger">delete</button>
